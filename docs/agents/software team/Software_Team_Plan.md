...
| Agent | 名稱 | 職責 |
|-------|------|------|
| **Reviewer** | 程式碼審查 | 專門負責 Code Review，比 Dev 兼做更深入，確保程式碼品質 |
| **Release** | 發版管理 | 管理版本號、整理 Changelog、產出 Release Notes、建立 GitHub Release tag |
| **Designer** | UI 設計規格 | 把功能需求轉換成 UI 規格文件，規劃頁面結構、MudBlazor 元件配置，讓 Dev 知道要做什麼畫面 |
