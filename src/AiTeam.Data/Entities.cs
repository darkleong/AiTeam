...
public class TokenLog
{
    ...
    /// nullable：v4 caller / 既有 row 全 null 不擾 / 0 行為改變。對齊既有 TaskId nullable FK 紀律。
    /// v4.0.5 F1：PetraSession entity 已 DROP TABLE / 此 column 留作 backward-compat dead column / Petra follow-up 評估是否續砍。</summary>
...
// v4.0.5 F1：v3-v5 dead entity 整段砍（Talent / TalentSkill / TaskMemory / TalentMemory / SkillPrompt / TalentPrompt / PetraInbox）
// 對應 DROP TABLE：talents / talent_skills / task_memories / talent_memories / skill_prompts / talent_prompts / petra_inbox
// 對齊 v4.0.0 純記錄系統定位 — 6 Talent / v5.5 Phase 1-3 整套搬到 Claude Code Agent Team 執行端
// PetraSession / PetraSessionMessage 砍見 PetraSession.cs / PetraSessionMessage.cs 整檔刪除
